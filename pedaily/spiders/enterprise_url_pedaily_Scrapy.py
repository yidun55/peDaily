...
class pedaily(Spider):
    """
    usage: scrapy crawl enterprise_list -a redis_key='your_key' -a start_url='http://zdb.pedaily.cn/enterprise/1/'
    """
    download_delay = 1
    ...
    def extract_url(self, response):
        ...
        """
        sel = response.selector
        detail_url = sel.xpath(u"//div[@class='company-list']//span[text()='简称：']/a/@href").extract()
        try:
